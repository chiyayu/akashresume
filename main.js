...
function basics(det) {
  ...
  email.href = "mailto:kakash3657@gmail.com";
...
function educationinfo(edu) {
  ...
  for (var i=0;i<edu.length;i++) {
    tabledata+="<tr><td>"+edu[i].qualification+"</td><td>"+edu[i].Institute+"</td><td>"+edu[i].year+"</td><td>"+edu[i].percentage+"</td><td>"+edu[i]+"</td></tr>";
}
...
function skills(skillinfo) {
  ...
  function openpage(){
    window.open("akash.html", "_self",true)
  }
